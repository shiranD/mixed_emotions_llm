...
class EmotionElicit:
    ...
    def __create_model(self, name):
        model = ChatOpenAI(
                ...
                #openai_api_key = "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",
                #openai_api_key = "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",
                #openai_api_key = "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",
                openai_api_key = "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",
        ...
        if i == 0:
            return PromptTemplate(template="ご参加いただきありがとうございます。\
                    ...
                    0（全く感じない）から4（非常に強く感じる）までの5段階の段階評価でお願いします。\
                     どのように感じるかは個人差があります。日本の参加者として評価してください。\n{format_instructions}\n{situation}",\
...
logging.basicConfig(filename=fname+"_jp_jp.log", encoding='utf-8', level=logging.DEBUG)
for i in range(20):
    df = new.generate_response()
    df.to_csv("results/conditioning/third_results/"+fname+"/jp_jp_"+fname+str(i))
